...
var headerView = {
  init: function() {
    this.headerNameElem = $("#header-name");
    this.headerRoleElem = $("#header-role");
    this.contactsMobileElem = $("#contacts-mobile");
    this.contactsEmailElem = $("#contacts-email");
    this.contactsTwitterElem = $("#contacts-twitter");
    this.contactsGithubElem = $("#contacts-github");
    this.headerPicElem = $("#biopic")
    this.headerDescElem = $("#header-desc");
    this.headerSkillsElem = $("#header-skills")

    this.render();
  },

  render: function() {
    var headerData = command.getHeaderData();
    headerView.headerNameElem.append(headerData.name);
    headerView.headerRoleElem.append(headerData.role);
    headerView.contactsMobileElem.append(headerData.contacts.mobile);
    headerView.contactsEmailElem.append(headerData.contacts.email);
    headerView.contactsTwitterElem.append(headerData.contacts.twitter);
    headerView.contactsGithubElem.append(headerData.contacts.github);
    headerView.headerDescElem.append(headerData.desc);
...
var projects = {
  "projects": [{
    ...
    "images": ["img/emaarFestive.jpg", "img/emaarNye.jpg"]
  }, {
    "title": "Churrasco Campaign",
    "dates": "2016",
    "description": "Managed overall Marketing Campaign for Churrasco Night at Cabana. I prepared the digital marketing strategy for this campaign that spanned the whole year. And with my marketing manager resigning for the year of 2015, I was given the opportunity to plan and implement the whole year strategy to promote Cabana Churrasco Campaign from Creative Design Concept to Campaign implementation for Print, Radio and Online. The campaign continued throughout the year with a kick-off event and complimentary bursts of tactical campaigns that sustained awareness and convert potential customers.",
    "images": ["img/emaarChurrasco.jpg", "img/emaarCabana.jpg"]
  }, {
    "title": "Smart Bro Series",
    "dates": "2011",
    ...
    "images": ["img/smartSmartbro.jpg", "img/smartTechskills.jpg"]
  }]
};
