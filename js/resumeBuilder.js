var bio = {
  ...
  "welcomeMessage": "Specializing in Digital Marketing with a background of Web \
...
education.display = function() {
  ...
  for (var i = 0; i < education.schools.length; i++) {
    ...
    var formatSchoolName = HTMLschoolName.replace("%data%", keySchool.name);
    ...
    $(".education-entry").append(formateTitleDegree);
    addItems(".education-entry", HTMLschoolLocation, keySchool.location);
    addItems(".education-entry", HTMLschoolDates, keySchool.dates);
    addItems(".education-entry", HTMLschoolMajor, keySchool.majors);
  }
  ...
  for (var x = 0; x < education.onlineCourses.length; x++) {
    ...
    addItems(".online-entry", HTMLonlineDates, keyOnline.dates);
    addItems(".online-entry", (HTMLonlineURL.replace("#", keyOnline.url)), keyOnline.url);
  }
  ...
  for (var y = 0; y < education.certifications.length; y++) {
    ...
    addItems(".certificate-entry", HTMLcertDates, keyCert.dates);
    addItems(".certificate-entry", (HTMLcertURL.replace("#", keyCert.url)), keyCert.url);
  }
};
